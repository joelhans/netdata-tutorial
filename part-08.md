...
You can create your own dashboard using simple HTML, in some cases for basic dashboards 
you may not have need for Javascript.
...
The `index.html` has a different syntax and should not be used as a template for custom dashboards.
