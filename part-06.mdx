...
When Netdata **starts**, it auto-detects data sources, such as database servers, web servers, and more.
...
To help explain how this process works, let's use an Nginx web server as an example.
...
Auto-detection
  What if this thing isn’t collected?
  Example: Nginx
...
> auto-detect containers and VMs.
 If Netdata isn't collecting metrics after a restart, your service/application probably isn't configured
