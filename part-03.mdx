...
### Example: Use a Netdata demo server 

If you don't have multiple systems to associate with your Netdata Cloud account, you can test all these features out
using a demo system.

Visit the [Netdata website](https://www.netdata.cloud/#live-demo) and click on any of the gauge charts displayed beneath **Live Demo**.
